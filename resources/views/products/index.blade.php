                                ...
                                <tbody>
                                    @foreach($products as $product)
                                        <tr>
                                            ...
                                            <td>{{$product->name}}</td>
                                            <td>{{$product->price}}</td>
                                            <td>{{$product->category_id!='' || $product->category->deleted_at == "" ? $product->category->name : 'ninguno'}}</td>
                                            <td>{{ $product->subcategory_id!='' || $product->subcategory->deleted_at == "" ? $product->subcategory->name : 'ninguno'}}</td>
