    ...
    <div class="col-12">
      ...
      <div class="form-group row">
        ...
        <div class="col-md-6">
          ...
          <input type="text" class="form-control  @error('bill_number') is-invalid @enderror" name="bill_number" id="bill_number" value="{{ empty($purchase) ? old('bill_number') : $purchase->bill_number }}">
           @error('bill_number')
            <span class="invalid-feedback" role="alert"><strong>{{ $message }}</strong></span>
          @enderror
        </div>
      ...
      <div class="form-group row">
        <div class="col-md-6">
          ...
          <input type="text" name="date" class="form-control fechita  @error('date') is-invalid @enderror" value="{{ empty($purchase) ? old('supplier') : $purchase->date->format('d-m-Y') }}">
